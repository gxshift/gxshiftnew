...
// KUNCI PERUBAHAN: Gunakan modul murni Client-Side untuk bypass Cloudflare Edge
...
export default function AdminLogin() {
  ...
  // Inisialisasi Supabase murni (LocalStorage) - Kebal dari pencegatan server
        ...
        <div className="glass-panel p-10 rounded-3xl border border-primary/20 shadow-[0_0_50px_rgba(166,255,0,0.05)] relative overflow-hidden backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              {/* Tampilkan error format Zod jika ada */}
            ...
            <button 
              ...
              className="w-full py-4 mt-4 bg-primary text-black font-extrabold rounded-xl hover:bg-[#b5ff2b] transition-all shadow-[0_0_20px_rgba(166,255,0,0.3)] hover:shadow-[0_0_30px_rgba(166,255,0,0.6)] flex items-center justify-center gap-2 text-sm uppercase group"
            >
              {isAuthenticating ? 'MEMVERIFIKASI...' : 'MASUK KE SISTEM'}
              {!isAuthenticating && <LogIn size={18} className="group-hover:translate-x-1 transition-transform" />}
            </button>
