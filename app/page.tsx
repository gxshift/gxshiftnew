        ...
        <section className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            ...
            <div className="glass-panel p-6 rounded-2xl flex flex-col items-center text-center hover-glow relative">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-primary/10 border border-primary/50 text-primary font-bold rounded-xl hover:bg-primary hover:text-black transition-all">
                ORDER VIA WHATSAPP
              </a>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl flex flex-col items-center text-center border-primary/50 relative shadow-[0_0_30px_rgba(166,255,0,0.15)] transform md:-translate-y-4">
              ...
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-primary text-black font-bold rounded-xl hover:bg-[#b5ff2b] transition-all shadow-lg">
                ORDER VIA WHATSAPP
              </a>
            </div>
